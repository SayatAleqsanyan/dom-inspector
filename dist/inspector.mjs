...
export { audit, clearMutations, connect, DOMInspector as default, destroy, detectFramework, disable, disconnect, enable, exportData as export, generateStableSelector, init, joinSession, off, on, patchAddEventListener, setTheme, share };
